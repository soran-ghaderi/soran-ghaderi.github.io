---
layout: post
title: "Generative Modeling with Energy-based Models"
...
When working with continuous-time generative models, we need numerical integrators to solve stochastic differential equations. TorchEBM provides several options, as shown in {% ref tab-integrators %}.
...
TorchEBM includes analytical energy functions useful for testing and benchmarking, as illustrated in {% ref fig-energy-landscapes %}.
